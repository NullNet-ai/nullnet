...
- Rework the Config page to edit services through per-field widgets instead of a raw TOML textarea, backed by a new structured `/api/service-config/{stack}` endpoint (fixes [#140](https://github.com/NullNet-ai/nullnet/issues/140))
